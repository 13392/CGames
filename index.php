...
<head>
    ...
    <base href="http://localhost/CGames/">
...
<body>
    <?php
        $url = "http://localhost/CGames/api/games.php";
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="home"><h3>CGames |</h3></a>
...
<footer>
    ...
    <p class='text-center bg-dark text-light'>Desenvolvido Por : <a href="Sue git" target="_blank">Cesar Henrique Mendonça</a></p>
